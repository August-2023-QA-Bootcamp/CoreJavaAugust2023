...
public class UseOfArray05 {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n------------------------------------------------------------------------");
		int [] c = Arrays.copyOfRange(b, 1, 7); // if you need to decrease or a specific size from the old Array
		...
		// Important, we will need it one Coding challenge
