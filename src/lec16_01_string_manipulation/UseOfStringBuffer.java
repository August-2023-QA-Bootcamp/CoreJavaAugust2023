...
// Code wise this is not Important at all
public class UseOfStringBuffer {
	
	// charAt(), replace(), lastIndexOf(), indexOf(), length(), substring() common with String
	...
	public static void main(String[] args) {
		...
		sb4.ensureCapacity(10); // if we fix a value the capacity is generally that, like the demand is --> 10
